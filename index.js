...
themeicon.addEventListener("click",()=>{
    ...
    if(themeicon.classList.contains("fa-sun")) {
        ...
        headerdiv.style.backgroundImage="url('https://cdn.jsdelivr.net/gh/Satyammishra1718/satyam_portfolio@main/images/background-image-light-theme.png')"
    }else{
        themeicon.classList.remove("fa-moon"); 
        themeicon.classList.add("fa-sun");  
        logotheme.src="images/logo-dark-theme.png" 
        headerdiv.style.backgroundImage="url('https://cdn.jsdelivr.net/gh/Satyammishra1718/satyam_portfolio@main/images/background-image-dark-theme.png')"
    }
